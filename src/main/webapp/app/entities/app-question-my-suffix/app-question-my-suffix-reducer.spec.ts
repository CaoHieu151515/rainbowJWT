...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-question-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPQUESTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPQUESTION actions', async () => {
      const expectedActions = [
        {
