...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-category-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPCATEGORY actions', async () => {
      const expectedActions = [
        {
