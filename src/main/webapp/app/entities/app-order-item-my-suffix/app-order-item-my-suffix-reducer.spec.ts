...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-order-item-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPORDERITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPORDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPORDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPORDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPORDERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPORDERITEM actions', async () => {
      const expectedActions = [
        {
