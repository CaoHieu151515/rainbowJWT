...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-multiple-choice-answer-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPMULTIPLECHOICEANSWER_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPMULTIPLECHOICEANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPMULTIPLECHOICEANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPMULTIPLECHOICEANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPMULTIPLECHOICEANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPMULTIPLECHOICEANSWER actions', async () => {
      const expectedActions = [
        {
