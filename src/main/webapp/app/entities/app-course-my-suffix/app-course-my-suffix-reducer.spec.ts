...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-course-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPCOURSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPCOURSE actions', async () => {
      const expectedActions = [
        {
