...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-cart-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPCART_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPCART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPCART actions', async () => {
      const expectedActions = [
        {
