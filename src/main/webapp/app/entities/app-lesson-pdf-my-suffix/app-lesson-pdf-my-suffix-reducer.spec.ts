...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-lesson-pdf-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLESSONPDF_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLESSONPDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLESSONPDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLESSONPDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLESSONPDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLESSONPDF actions', async () => {
      const expectedActions = [
        {
