...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-lesson-video-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLESSONVIDEO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLESSONVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLESSONVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLESSONVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLESSONVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLESSONVIDEO actions', async () => {
      const expectedActions = [
        {
