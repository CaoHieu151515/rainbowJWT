...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './link-account-user-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINKACCOUNTUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINKACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINKACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINKACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINKACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINKACCOUNTUSER actions', async () => {
      const expectedActions = [
        {
