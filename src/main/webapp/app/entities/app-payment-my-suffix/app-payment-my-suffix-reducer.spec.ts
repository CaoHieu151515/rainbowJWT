...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-payment-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPPAYMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPPAYMENT actions', async () => {
      const expectedActions = [
        {
