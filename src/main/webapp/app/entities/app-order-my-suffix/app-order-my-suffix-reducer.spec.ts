...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-order-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPORDER actions', async () => {
      const expectedActions = [
        {
