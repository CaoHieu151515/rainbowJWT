...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-lesson-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLESSON_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLESSON actions', async () => {
      const expectedActions = [
        {
