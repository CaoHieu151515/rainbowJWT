...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-question-video-info-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPQUESTIONVIDEOINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPQUESTIONVIDEOINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPQUESTIONVIDEOINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPQUESTIONVIDEOINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPQUESTIONVIDEOINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPQUESTIONVIDEOINFO actions', async () => {
      const expectedActions = [
        {
