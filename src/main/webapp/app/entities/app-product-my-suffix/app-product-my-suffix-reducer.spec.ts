...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-product-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPPRODUCT_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPPRODUCT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPPRODUCT actions', async () => {
      const expectedActions = [
        {
