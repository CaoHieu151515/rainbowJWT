...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-product-image-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPPRODUCTIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPPRODUCTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPPRODUCTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPPRODUCTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPPRODUCTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPPRODUCTIMAGE actions', async () => {
      const expectedActions = [
        {
