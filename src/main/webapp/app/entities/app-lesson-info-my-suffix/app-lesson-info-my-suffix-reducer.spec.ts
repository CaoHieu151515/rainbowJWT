...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-lesson-info-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLESSONINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPLESSONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPLESSONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPLESSONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPLESSONINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPLESSONINFO actions', async () => {
      const expectedActions = [
        {
