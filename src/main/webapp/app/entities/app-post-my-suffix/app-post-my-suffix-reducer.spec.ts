...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-post-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPPOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPPOST actions', async () => {
      const expectedActions = [
        {
