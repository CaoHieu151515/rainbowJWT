...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-available-course-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPAVAILABLECOURSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPAVAILABLECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPAVAILABLECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPAVAILABLECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPAVAILABLECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPAVAILABLECOURSE actions', async () => {
      const expectedActions = [
        {
