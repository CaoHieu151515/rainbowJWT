...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-post-image-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPPOSTIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPPOSTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPPOSTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPPOSTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPPOSTIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPPOSTIMAGE actions', async () => {
      const expectedActions = [
        {
